...
import { MdMetricsService } from './metrics.service';

@Component({
  selector: 'md-metrics',
  templateUrl: './metrics.component.html'
})
export class MdMetricsMonitoringComponent implements OnInit {
  metrics: any = {};
  threadData: any = {};
  updatingMetrics = true;
  JCACHE_KEY: string;

  constructor(private metricsService: MdMetricsService) {
