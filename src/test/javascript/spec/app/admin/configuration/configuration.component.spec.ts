...
import { MdConfigurationComponent } from 'app/admin/configuration/configuration.component';
import { MdConfigurationService } from 'app/admin/configuration/configuration.service';

describe('Component Tests', () => {
  describe('MdConfigurationComponent', () => {
    let comp: MdConfigurationComponent;
    let fixture: ComponentFixture<MdConfigurationComponent>;
    let service: MdConfigurationService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [MindefAppTestModule],
        declarations: [MdConfigurationComponent],
        providers: [MdConfigurationService]
      })
        .overrideTemplate(MdConfigurationComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(MdConfigurationComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(MdConfigurationService);
    });
