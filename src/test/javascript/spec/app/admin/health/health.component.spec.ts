...
import { MdHealthCheckComponent } from 'app/admin/health/health.component';
import { MdHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('MdHealthCheckComponent', () => {
    let comp: MdHealthCheckComponent;
    let fixture: ComponentFixture<MdHealthCheckComponent>;
    let service: MdHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [MindefAppTestModule],
        declarations: [MdHealthCheckComponent]
      })
        .overrideTemplate(MdHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(MdHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(MdHealthService);
    });
