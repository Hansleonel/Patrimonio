package pe.gob.mindef.app.config.timezone;

import pe.gob.mindef.app.MindefApp;
import pe.gob.mindef.app.repository.timezone.DateTimeWrapper;
import pe.gob.mindef.app.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM md_date_time_wrapper where id=%d", fieldName, id);
    }
